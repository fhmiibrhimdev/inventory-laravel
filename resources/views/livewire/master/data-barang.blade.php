                    ...
                    <div class="card-body px-0">
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <thead>
                                    <tr class="tw-border-b tw-text-sm text-center text-uppercase">
                                        <th class="p-3">Gambar</th>
                                        <th class="p-3">QRCode</th>
                                        <th class="p-3">BARANG</th>
                                        <th class="p-3">KTGRI</th>
                                        <th class="p-3">RAK</th>
                                ...
                                <tbody>
                                    @forelse ($data as $row)
                                    <tr
                                        class="tw-bg-white tw-border tw-border-gray-100 hover:tw-bg-gray-50 tw-text-base">
                                        <td class="p-3"><img class="tw-rounded-lg"
                                                src="{{ asset('storage/'.$row->gambar) }}" width="90%" alt=""></td>
                                        <td class="p-3">{{ $row->kode_item }}</td>
                                        <td class="p-3">{{ $row->nama_item }}</td>
                                        <td class="p-3">{{ $row->kode_kategori }}</td>
                                        <td class="p-3">{{ $row->nama_rak }}</td>
                                        <td class="p-3 tw-text-right">{{ $row->stock }},00</td>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div wire:ignore>
                                                <select class="form-control tw-rounded-lg" name="id_jenis" id="id_jenis"
                                                    wire:model='id_jenis'>
                                                    @foreach ($jenis as $jeniss)
                                                    <option value="{{ $jeniss->id }}">{{ $jeniss->nama_jenis }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div wire:ignore>
                                                <select class="form-control tw-rounded-lg" name="id_merek" id="id_merek"
                                                    wire:model='id_merek'>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div wire:ignore>
                                                <select class="form-control tw-rounded-lg" name="edit_id_jenis"
                                                    id="edit_id_jenis" wire:model='id_jenis'>
                                                    @foreach ($jenis as $jeniss)
                                                    <option value="{{ $jeniss->id }}">{{ $jeniss->nama_jenis }}
                                                    </option>
                                                    @endforeach
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div wire:ignore>
                                                <select class="form-control tw-rounded-lg" name="edit_id_merek"
                                                    id="edit_id_merek" wire:model='id_merek'>
                                                    @foreach ($mereks as $merek)
                                                    <option value="{{ $merek->id }}">{{ $merek->nama_merek }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div wire:ignore>
                                                <select class="form-control tw-rounded-lg" name="edit_id_satuan"
                                                    id="edit_id_satuan" wire:model='id_satuan'>
                                                    @foreach ($satuans as $satuan)
                                                    <option value="{{ $satuan->id }}">{{ $satuan->nama_satuan }}
                                                    </option>
                                                    @endforeach
