<div>
    <div class="section-header tw-rounded-lg tw-text-black tw-shadow-md tw-shadow-gray-200">
        <h4 class="tw-text-lg">Master Data - Kategori</h4>
    </div>
                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control tw-rounded-lg" name="kode_kategori" id="kode_kategori" wire:model='kode_kategori'>
                                @error('kode_kategori') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label for="nama_kategori">Nama Kategori</label>
                                <input type="text" class="form-control tw-rounded-lg" name="nama_kategori" id="nama_kategori" wire:model='nama_kategori'>
                            ...
                            <table class="tw-table-fixed tw-w-full tw-text-black tw-text-md mt-3 tw-border-collapse tw-border">
                                <thead>
                                    <tr class="tw-border-b tw-text-xs text-center text-uppercase">
                                        <th class="p-3" width="20%">KODE KATEGORI</th>
