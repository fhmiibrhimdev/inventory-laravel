                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control tw-rounded-lg" name="kode_jenis" id="kode_jenis" wire:model='kode_jenis'>
                                @error('kode_jenis') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label for="nama_jenis">Nama Jenis</label>
                                <input type="text" class="form-control tw-rounded-lg" name="nama_jenis" id="nama_jenis" wire:model='nama_jenis'>
                            ...
                            <table class="tw-table-fixed tw-w-full tw-text-black tw-text-md mt-3 tw-border-collapse tw-border">
                                <thead>
                                    <tr class="tw-border-b tw-text-xs text-center text-uppercase">
                                        <th class="p-3" width="20%">KODE JENIS</th>
                                ...
                                <tbody>
                                    @forelse ($data as $row)
                                        <tr class="tw-bg-white tw-border tw-text-uppercase tw-border-gray-200 hover:tw-bg-gray-50">
                                            <td class="p-3">{{ $row->kode_jenis }}</td>
